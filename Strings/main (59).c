...
int main()
{
    char array1[10];//creates character array with 10 characters 
    char array2[10];//create character array with 10 characters
    ...
    printf("\nplease enetr frist string: ");//print enter frist string
    ...
    if(strcmp(array1,array2) ==0){//compare the two string array1 and array 2
        printf("string are equal\n");//print string is equal 
    }
    else{
    printf("string not equal\n");//print is string not equal
    }
    ...
    printf("length of the concatenated version is %d\n", length);//print the lenght of concatenated version
